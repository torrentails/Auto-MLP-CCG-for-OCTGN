...
def uuid(seed=None):
    """Generates a uuid based on seed

        Args:
            int seed: If set the random seed will be set to seed before the
                class::UUID is generated.

        Returns:
            UUID: either a fixed seed class::UUID or a class::UUID version 4
    """
    if seed:
